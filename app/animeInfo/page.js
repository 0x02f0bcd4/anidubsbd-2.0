                ...
                <div className="my-2 min-[550px]:flex flex-row gap-1 flex-wrap justify-around items-center">
                    {
                        json.see_more.map((value)=>{
                            if(value.id!==json.values.id){
                                ...
                                return (
                                    <a key={value.id}  className="border border-slate-500 border-solid rounded items-center my-2 h-[20dvh] max-h-[100px] min-[550px]:h-[250px] min-[550px]:max-h-[250px] flex flex-row min-[550px]:flex-col w-[95%] min-[550px]:w-[150px] mx-auto min-[550px]:m-0 min-[550px]:p-2" href={`/animeInfo?id=${value.id}`}>
